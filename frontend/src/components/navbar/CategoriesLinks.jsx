  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <p className="hover:text-black">Shopping</p>
      ...
      <div
        ...
        } flex-col gap-3 pl-5 pt-2 mb-2 md:absolute md:top-11 md:bg-green md:w-full md:left-0 md:p-3 md:rounded`}
      >
        <NavLink
          to="/shopping"
          className="text-sm md:hover:text-black md:text-end md:text-base"
